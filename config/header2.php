...
<!-- Mirrored from upbitinvest.ltd/?a=signup by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jun 2021 18:19:24 GMT -->
<head>
  	<meta charset="utf-8">
                ...
                <div class="col-md-12">
                  <nav class="navbar navbar-inverse">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                      ...
                      <li><a href="login.php" class="head-but1"></a></li>
                    	<li><a href="signup.php" class="head-but2"></a></li>
                    	</ul>
                    </div>
